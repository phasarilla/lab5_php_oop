| Dutha Khris Phasarilla | TI.21 C.6   |
| ---------------------- | ----------- |
| Pemrograman Web 2      | Praktikum 5 |

# Lab5_Web

Disini saya akan membuat prpgram OOP sederhana menggunakan PHP
...
## 4). Membuat file baru dengan nama form.php
...
## 5). Membuat file baru dengan nama form_input.php
